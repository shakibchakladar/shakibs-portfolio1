  ...
  return (
    <nav>
      <div className="container flex items-center justify-center p-6 mx-auto text-gray-300 capitalize">
        <a
          href=""
          className=" transition-colors duration-300 transform text-gray-200 border-b-2 border-blue-500 mx-1.5 sm:mx-6"
        >
          home
        </a>
        ...
        <a
          href="#"
          className="border-b-2 border-transparent  transition-colors duration-300 transform hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"
        >
          <svg
